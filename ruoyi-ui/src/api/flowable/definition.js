...
// 查询用户有权限发起的流程定义列表
export function listDefinitionWithPermission(query) {
  return request({
    url: '/flowable/definition/listWithPermission',
    method: 'get',
    params: query
  })
}
...
export function getProcessVariables(taskId,deployId) {
  return request({
    url: '/flowable/task/processVariables/' + taskId+"/"+deployId,
    method: 'get'
  })
}
...
// 获取流程历史版本列表
export function getProcessHistory(processKey) {
  return request({
    url: '/flowable/definition/history/' + processKey,
    method: 'get'
  })
}

// 删除流程历史版本
export function deleteProcessHistory(deploymentId) {
  return request({
    url: '/flowable/definition/history/' + deploymentId,
    method: 'delete'
  })
}
...
export function rollbackToVersion(data) {
  return request({
    url: '/flowable/definition/rollback',
    method: 'post',
    data: data
  })
}
