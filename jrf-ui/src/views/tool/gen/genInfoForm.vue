...
<!--      </el-col>-->
      ...
      <el-col :span="12">
        <el-form-item prop="rowType">
          <template #label>单双行</template>
          <el-select v-model="info.rowType">
            <el-option label="单行" value="1" />
            <el-option label="双行" value="2" />
          </el-select>
        </el-form-item>
      </el-col>
...
// 表单校验
const rules = ref({
  rowType: [{ required: true, message: "请选择单双行", trigger: "blur" }],
