...
public class FlowTaskController extends BaseController {
    ...
    @GetMapping(value = "/processVariables/{taskId}/{deployId}")
    public AjaxResult processVariables(@ApiParam(value = "流程任务Id") @PathVariable(value = "taskId") String taskId,@PathVariable(value = "deployId") String deployId) {
        return flowTaskService.processVariables(taskId,deployId);
    }
    ...
    public AjaxResult flowTaskForm(@RequestParam(value = "taskId", required = false) String taskId,@RequestParam(value = "deployId", required = false) String deployId) throws Exception {
        return flowTaskService.flowTaskForm(taskId,deployId);
    }
